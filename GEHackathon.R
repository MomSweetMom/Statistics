...
data_study = tbl_df(data_study)
View(data_study)
str(data_study)

new = arrange(data_study, ae_key, id)
View(new)
args(arrange)

x1 = group_by(data_study, hospital_name)
summarize(x1, count = n())

head = select(data_study, contains('1.1'))
View(head)
